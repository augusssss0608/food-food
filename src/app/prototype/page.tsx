...
const VARIANTS: { slug: string; title: string; tagline: string; desc: string }[] = [
  ...
  { slug: 'v5-ledger', title: '2. Today Ledger', tagline: 'Inline insert into diary',
    desc: '取消 + 按鈕，「今日已記錄」末尾就是輸入入口。MyFitnessPal Quick Add 心智。' },
  { slug: 'v7-dial', title: '3. Macro Dial', tagline: 'iPod click wheel',
  ...
  return (
    <div className="min-h-dvh bg-ink text-text px-5 py-8 max-w-md mx-auto">
      <header className="mb-7">
        ...
        <h1 className="display-roman text-[30px] leading-tight">3 種新增餐入口</h1>
