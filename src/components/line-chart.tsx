        ...
        >
          ...
          {points.map((p, i) => (
            <text
              ...
              textAnchor="middle"
              fontSize={DATE_FONT}
              fill={i === points.length - 1 ? color : 'var(--color-text-3)'}
              className="font-mono"
              style={{ fontWeight: i === points.length - 1 ? 600 : 400 }}
            >
              {formatDate(p.date)}
